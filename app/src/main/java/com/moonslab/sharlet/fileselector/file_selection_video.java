...
public class file_selection_video extends Fragment {
    Context context;
    int next_start;
    ...
    public List<File> All_files(Context context) {
        ...
        try {
            ...
            cursor = new MergeCursor(new Cursor[]{
                    context.getContentResolver().query(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, columns, null, null, sort_video)
            });
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        main_view = inflater.inflate(R.layout.fragment_file_selection_video, container, false);
